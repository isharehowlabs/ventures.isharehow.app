...
export default function OpportunityPanel() {
  ...
  const [opportunities, setOpportunities] = useState<Opportunity[]>([
    {
      id: '1',
      title: 'MSSP Security Monitoring',
      description: 'Managed security service provider opportunity for mid-size enterprise',
      type: 'mssp',
      status: 'negotiation',
      value: 50000,
      priority: 'high',
    },
    {
      ...
      description: 'Security Operations Center setup for financial institution',
      type: 'soc',
      status: 'lead',
      value: 75000,
      priority: 'medium',
  ...
  const handleOpenBoard = (oppId: string) => {
    router.push(`/board?boardId=opportunity_${oppId}`);
  };
