  ...
  return (
    <>
      ...
      <AppShell active="rise">
        ...
        {/* Tabs - Reordered with Rise Journey after Overview */}
        <Paper 
          sx={{ 
            mb: 3,
        ...
        {/* Tab 1: Overview - Now includes Goals & Achievements */}
        <TabPanel value={currentTab} index={0}>
          <Grid container spacing={3}>
            ...
            {/* Goals Section - Moved from separate tab */}
            ...
            {/* Achievements Section - Moved from separate tab */}
