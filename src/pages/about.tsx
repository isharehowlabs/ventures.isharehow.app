...
const AboutPage = () => {
  ...
  return (
    <>
      <Head>
        <title>About | iShareHow Labs - Empowering Your Vision with Managed Solutions</title>
        <meta
          name="description"
      ...
      <AppShell active="about">
        <Box>
          ...
          {/* Section 2: Experience & Design Services */}
