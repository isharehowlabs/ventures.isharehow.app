#!/usr/bin/env python3
"""
Direct migration to create clients table and related tables
This creates the clients, client_employee_assignments, client_dashboard_connections tables
"""
import os
import sys
...
def run_migration():
    """Run the migration to create clients and related tables"""
    ...
    try:
        ...
        print("\nVerification:")
        tables = ['clients', 'client_employee_assignments', 'client_dashboard_connections', 'support_requests']
        for table in tables:
            if check_table_exists(engine, table):
                print(f"  ✓ {table} table exists")
            else:
                print(f"  ✗ {table} table NOT found (migration may have failed)")
...
if __name__ == '__main__':
    print("=" * 60)
    print("Database Migration: Create Creative Dashboard Tables")
    print("=" * 60)
    print()
    run_migration()
